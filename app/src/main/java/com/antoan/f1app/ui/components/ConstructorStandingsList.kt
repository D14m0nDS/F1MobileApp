...
@Composable
fun ConstructorStandingsList(constructorStandings: List<ConstructorStandings>, navController: NavController, viewModel: StandingsViewModel) {
    ...
    LazyColumn(Modifier.fillMaxSize()) {
        item {
            Row(
                ...
                Text("Constructor", style = MaterialTheme.typography.bodyLarge, modifier = Modifier.weight(3f).padding(start = 10.dp))
        ...
        items(constructorStandings) { constructor ->
            ...
            val imageUrl = remember(constructor.constructorId, dpi) {
                val teamLogoImage = constructor.constructorId
            ...
            Box(
                ...
                Row(
                    ...
                    Text(constructor.position.toString(), textAlign = TextAlign.Center, style = MaterialTheme.typography.bodyLarge, modifier = Modifier.weight(0.5f))
                    Box(
                        modifier = Modifier
                            .weight(0.75f)
                            .fillMaxHeight(),
                    ...
                    Text(constructor.name, style = MaterialTheme.typography.bodyLarge, modifier = Modifier.weight(2.25f))
                    Text(constructor.points.toString(), textAlign = TextAlign.Center, style = MaterialTheme.typography.bodyLarge, modifier = Modifier.weight(1f))
                    Text(constructor.wins.toString(), textAlign = TextAlign.Center, style = MaterialTheme.typography.bodyLarge, modifier = Modifier.weight(1f))
                }
            }
